      ...
      <div className="min-h-screen bg-hero-radial">
        ...
        <main>
          <Routes>
            ...
            <Route path="/discover" element={<Discover userId={user.id? user.id : user.user.id}/>} />     
            <Route path="/admin" element={<AdminDashboard />} />                 {/* Discover page, shows potential matches based on swiping algorithm. */}
            <Route
              path="/suggested"
              element={
